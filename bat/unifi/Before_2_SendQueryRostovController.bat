...
echo set-inform http://10.78.221.142:8080/inform | clip

@echo.
echo ************************************************
echo *  Text:                                       *
echo *  set-inform http://10.78.221.142:8080/inform *
...
rem (mca-cli;set-inform http://10.78.221.142:8080/inform)
